      ...
      fetch("/send-new-request", {
        ...
        .then((data) => {
          ...
          document.getElementById("root").innerHTML = categories
            ...
            <input name="itemName" value="${item_name}" onchange='updateItemName(${i}, this.value)' required>
            </div>

            <div class="form-group">
            <label for="unit">Unit:</label>
            <input name="unit" value="${unit}" onchange='updateUnit(${i}, this.value)' required>
            </div>
...
function addtocart(a) {
  const existingItemIndex = cart.findIndex((item) => item.item_name === categories[a].item_name);
  ...
  fetch("/cart", {
    ...
    .then((response) => {
      if (response.ok) {
        ...
        window.location.href = "/add-store-manager-request";
      } else {
